        ...
        ">
          <div class="col-sm">
            <div class="form-group">
              <label for="exampleInputEmail1">বিয়ে কেন করছেন? বিয়ে সম্পর্কে আপনার ধারণা কি? *</label>
              <input type="email" class="form-control" id="floatingInput" placeholder="">
            </div>
            <br />
            <a href="./lifePartner.html"><button type="button" class="btn btn-info">save changes </button></a>
