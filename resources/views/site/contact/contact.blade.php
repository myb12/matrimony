        ...
        ">
          <div class="col-sm">
            <div class="form-group">
              <label for="exampleInputEmail1">মোবাইল নাম্বার *</label>
              <input type="email" class="form-control" id="floatingInput" placeholder="০১*** ** ** **">
            </div>
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">অভিভাবক এর নাম্বার</label>
              <input type="email" class="form-control" id="floatingInput" placeholder="০১*** ** ** **">
            </div>
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">মেইল এড্রেস</label>
              <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
            </div>
            <br />
            <a href="../../index.html"><button type="button" class="btn btn-info">তথ্য গুলো সংরক্ষন করুন </button></a>
