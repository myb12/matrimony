        ...
        ">
          <div class="col-sm">
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="floatingInput" placeholder="যেমন বয়সের পাত্র/পাত্রী চাচ্ছেন">
            </div>
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">বয়স *</label>
            ...
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">নূন্যতম উচ্চতা *</label>
              <input type="email" class="form-control" id="floatingInput"
                placeholder="যেমন উচ্চতার পাত্র/পাত্রী চাচ্ছেন">
            </div>
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">নূন্যতম শিক্ষাগত যোগ্যতা *</label>
              <input type="email" class="form-control" id="floatingInput"
                placeholder="যেমন শিক্ষিত পাত্র/পাত্রী চাচ্ছেন">
            </div>
            <br />
            <div class="form-group">
            ...
            <br />
            <div class="form-group">
              <label for="exampleInputEmail1">জীবনসঙ্গীর যে বৈশিষ্ট্য বা গুণাবলী আশা করেন *
              </label>
              <input type="email" class="form-control" id="floatingInput" placeholder="সময় নিয়ে লিখুন">
            </div>
            <br />
            <br />
            <a href="./contact.html"><button type="button" class="btn btn-info">save changes </button></a>
